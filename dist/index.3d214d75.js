...
const register = async (event)=>{
    ...
    if (passValue.length >= 6) // metoda 1
    ...
    //metoda 2
    try {
        const response = await (0, _auth.createUserWithEmailAndPassword)(auth, emailValue, passValue);
        if (!response) return alert("response is not ok");
        console.log(response);
    } catch (error) {
        console.error();
    }
    else alert("Hasło musi mieć minimum 6 znak\xf3w");
...
const signIn = async (event)=>{
    ...
    try {
        const response = await (0, _auth.signInWithEmailAndPassword)(auth, emailValue, passwordValue);
...
},{"./firebaseConfig":"jXx9b","firebase/auth":"79vzg"}],"jXx9b":[function(require,module,exports) {
...
},{"firebase/app":"aM3Fo","firebase/analytics":"bSFRu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aM3Fo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _app = require("@firebase/app");
...
var process = require("ff1fc9e8c2c24a3d");
var global = arguments[3];
const CONSTANTS = {
    /**
...
},{"ff1fc9e8c2c24a3d":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8BXtR","bB7Pu"], "bB7Pu", "parcelRequiredba7")
